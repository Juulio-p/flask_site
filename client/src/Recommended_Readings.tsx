        ...
        <li>
          <Card shadow="sm" padding="lg" radius="md" withBorder>
            ...
            <Text size="sm" c="dimmed">
              Finding quality hires on short notice used to be a challenge for
              our company—until we found **emergenZhire**. Their platform made
              the process seamless, connecting us with top-tier candidates in
              record time. Thanks to emergenZhire, we were able to fill crucial
              positions with highly skilled professionals, ensuring our
              operations never missed a beat. Highly recommended!"
            </Text>
          </Card>
        </li>
